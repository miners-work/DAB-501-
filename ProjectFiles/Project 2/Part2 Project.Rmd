...
Ans.
```{r}
ggplot(usawest2020_21,aes(x = Month, y = ..prop.., group =1),stat = 'count' )+geom_bar(fill ='sky blue', color ='black')
```

3. Discuss any unusual observations for this variable? 
Ans. In the first graph for the year 2020 the value for the variable increases in the last few months with 12th month of 2020 with the highest deaths, whereas in 2021 graph the number of deaths is higher during the first few months with 1st month having highes number of deaths.
...
ggplot(usaallentries,aes(x = Group, y = ..prop.., group =1),stat = 'count' )+
 ...
 geom_bar(fill ='sky blue', color ='black')
```
3. Discuss any unusual observations for this variable? 
